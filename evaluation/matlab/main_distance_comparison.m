...
basicData = readmatrix('./input data/Geometric/16Channel__First_Frame.csv', 'Delimiter', ',');
...
preciseData = readmatrix('./input data/Geometric/16Channel__First_Frame_Precise.csv', 'Delimiter', ',');
...
mean(inlierBasicDist)
mean(inlierPreciseDist)
