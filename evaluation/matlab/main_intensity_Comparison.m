...
basicData = readmatrix('./input data/Radiometric/16Channel__First_Frame.csv', 'Delimiter', ',');
...
preciseData = readmatrix('./input data/Radiometric/16Channel__First_Frame_Precise2.csv', 'Delimiter', ',');
